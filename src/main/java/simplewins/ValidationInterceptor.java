...
//
// Modified for Quarkus integration:
// - Changed package from buf.build.example.protovalidate to simplewins
// - Added @ApplicationScoped and @GlobalInterceptor annotations
// - Changed from constructor injection to CDI @Inject
